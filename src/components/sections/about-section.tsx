        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              ...
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Мы помогаем маркетологам, SEO-специалистам и digital-агентствам понять, как бренд выглядит в эпоху ИИ-поиска, и планомерно улучшать эту видимость.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              { value: "12+", label: "LLM-платформ", sublabel: "ChatGPT, Perplexity, Claude, Gemini и другие", direction: "right" },
              { value: "24/7", label: "Мониторинг", sublabel: "Автоматический сбор данных без вашего участия", direction: "left" },
