  ...
  const features = [
    {
      ...
      description: "Автоматический мониторинг упоминаний бренда в ChatGPT, Perplexity, Claude, Gemini и других LLM.",
      direction: "top",
    },
    {
      title: "Конкурентная аналитика",
      description: "Сравнивайте свою видимость с конкурентами. Узнайте, кто чаще упоминается в ИИ-ответах.",
      direction: "right",
    },
    {
      title: "Исторические тренды",
      description: "Дашборды с динамикой видимости и графиками упоминаемости. Отслеживайте рост или падение в LLM.",
      direction: "left",
    },
    {
      title: "Отчёты и алерты",
      description: "Экспортируйте данные в PDF/CSV, настраивайте уведомления и получайте еженедельные дайджесты.",
      direction: "bottom",
    },
  ]
    ...
    >
      <div className="mx-auto w-full max-w-7xl">
        ...
        >
          ...
          <p className="font-mono text-xs text-foreground/60 md:text-base">/ Что умеет Флоустат</p>
        </div>

        <div className="grid grid-cols-2 gap-x-6 gap-y-6 md:grid-cols-2 md:gap-x-16 md:gap-y-12 lg:gap-x-24">
...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="mb-1 font-sans text-base font-light text-foreground md:mb-2 md:text-3xl">{feature.title}</h3>
      <p className="text-xs leading-relaxed text-foreground/80 md:text-base">{feature.description}</p>
    </div>
  )
}
